package com.udemy.companies_crud.configs;
...
/**
 * Esta clase es para meter en el contexto todas las dependencias que agregamos.
 * 
 * */
...
public class ObserverBeans {
    ...
    //Antes esto se hacia automaticamente pero ya esta deprecado.
    @Bean
