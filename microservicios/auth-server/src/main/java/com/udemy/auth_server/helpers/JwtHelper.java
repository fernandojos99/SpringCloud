package com.udemy.auth_server.helpers;
...
public class JwtHelper {
    ...
    public boolean validateToken(String token) {
        try {
        	// cuando se hace el getExpirationDate ya se valida la firma lo unico 
        	// que queda es validad la fecha .
    ...
    // Cuando obtenemos el key estamos firmando el token 
